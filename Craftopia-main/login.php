...
?>
        ...
        <section class="htc__contact__area ptb--100 bg__white" style="background-image: url('media/background.jpg'); background-size: cover; padding:20px 30px;">
            <div class="container">
                <div class="row">
				<div class="col-md-6">
						...
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
								<form id="login-form" method="post">
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="text" name="login_email" id="login_email" placeholder="Enter Email" style="width:100%">
										</div>
