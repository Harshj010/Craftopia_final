...
?>
						...
						<div class="contact-form-wrap mt--60">
							<div class="col-xs-12">
								...
								<div class="contact-title">
									<h2 class="title__line--6">Your Profile</h2>
								</div>
							</div>
							<div class="col-xs-12">
								<form id="login-form" method="post">
									...
									<div class="contact-btn">
										<button type="button" class="fv-btn fr__btn" onclick="update_profile()" id="btn_submit">Update</button>
								...
								<div class="col-xs-12">
									<div class="contact-title">
										<h2 class="title__line--6">Your Email</h2>
									</div>
								</div>
								<form id="login-form" method="post">
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="text" name="email" id="email" placeholder="Your Email" style="width:100%" value="<?php echo $_SESSION['USER_EMAIL']?>">
										</div>
										<span class="field_error" id="name_error"></span>
									</div>
									
									<div class="contact-btn">
										<button type="button" class="fv-btn fr__btn" onclick="update_email()" id="email_btn_submit">
										Update
										</button>										
									</div>
								</form>
						...
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
								<form method="post" id="frmPassword">
									<div class="single-contact-form">
										<label class="password_label">Enter Current Password</label>
										<div class="contact-box name">
									...
									<div class="contact-btn">
										<button type="button" class="fv-btn fr__btn" onclick="update_password()" id="btn_update_password">Update</button>
		...
		function update_email(){
			...
			if(email==''){
				...
				jQuery('#email_btn_submit').html('Please wait...');
				jQuery('#email_btn_submit').attr('disabled',true);
				jQuery.ajax({
					...
					success:function(result){
						...
						jQuery('#email_btn_submit').html('Update');
						jQuery('#email_btn_submit').attr('disabled',false);
					}
				})
			}
		}
